...
- **Structural controls:** ButtonBase owns the native reset, focus ring, disabled opacity, press motion, and theme pointer coordinates without imposing action-button layout or chrome. Consumers own the control's geometry and use theme tokens for resting and hover styles.
