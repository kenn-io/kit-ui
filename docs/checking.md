...
| `hand-rolled-drawer`         | `drawer` class and structural compounds, plus explicit `bottom-dock`, `bottom-panel`, and `bottom-tray` classes; other `drawer-*`, generic dock names, and kit component classes are exempt | `DetailDrawer`, `BottomDock`                                                               |
