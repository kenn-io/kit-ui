...
| `hand-rolled-drawer`         | `drawer` class and its structural compounds (`drawer-panel`, `drawer-backdrop`, …); other `drawer-*` names and kit component classes are exempt                                             | `DetailDrawer`, `BottomDock`                                                               |
