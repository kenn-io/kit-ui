...
| ---------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------ |
| `hand-rolled-disabled-state` | literal opacity on a control's `:disabled` or `[aria-disabled]` rule                                                                                                                        | `kit-control-states` or `var(--opacity-disabled)`                                          |
| `hand-rolled-press-state`    | custom `transform` on a control's `:active` rule                                                                                                                                            | `kit-control-states` or `var(--press-transform)`                                           |
