...
`trailing` is for decorative indicators only — mark icons
...
| `trailing`                                           | `Snippet`                                                                                                       | —       | Decorative trailing indicator outside the label (e.g. dropdown chevron); survives label truncation. Not for interactive content |
