...
| `adaptive-action-grid.spec.ts` | Row, grid, and compact transitions; nested selector state and keyboard behavior; resize focus handling; zero-gap joined geometry                                                                                                                                      |
