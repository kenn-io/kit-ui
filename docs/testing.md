...
| `refresh-control.spec.ts`      | Width reservation: the age label box measures the same across the narrowest, widest, and overlong variants, and the element after the control does not move                                                                                                           |
