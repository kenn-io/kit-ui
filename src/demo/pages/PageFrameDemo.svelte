...
<DemoSection
  title="PageFrame"
  description="The centered Kenn account-page shell. Applications keep routing, authentication, organization selection, and submit behavior."
>
    ...
    >
      <div class="page-frame-demo__stack">
        <Notice
          ...
          message="Check your details, then try again."
          actionLabel="Try again"
          onaction={() => undefined}
        />
        <FormField field={email} type="email" autocomplete="email" oninput={updateEmail} />
      </div>
    </PageFrame>
  </div>
</DemoSection>
...
<style>
  .page-frame-demo {
    --kit-page-frame-min-height: 100%;

    width: 100%;
    min-height: 620px;
  }

  .page-frame-demo__stack {
    display: flex;
