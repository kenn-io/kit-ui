...
<DemoSection
  ...
  description="Tiny presence indicator: pulsing green while working, a breathing speech bubble when the agent is waiting on the user, amber for stale, red for unclean."
