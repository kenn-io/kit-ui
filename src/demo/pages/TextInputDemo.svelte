...
<DemoSection
  title="TextInput"
  description="The bordered field primitive: compact 24px and 28px toolbar sizes plus a 36px-minimum form size, with focus and invalid states on the wrapper and prefix/suffix snippets inside the border."
...
>
  <div class="col">
    ...
    <div class="row">
      ...
      <TextInput size="lg" placeholder="lg (36px minimum)" ariaLabel="Large form example" />
