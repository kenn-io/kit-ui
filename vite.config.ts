...
export default defineConfig({
  plugins: [svelte()],
  // Generated by `bun run generate:types`; linting emitted declarations only
  // reports on svelte2tsx/tsc output style, not on authored code.
  lint: { ignorePatterns: ["types/**"] },
  build: {
